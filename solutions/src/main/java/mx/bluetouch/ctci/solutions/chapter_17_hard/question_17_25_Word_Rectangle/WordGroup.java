package mx.bluetouch.ctci.solutions.chapter_17_hard.question_17_25_Word_Rectangle;
...
public class WordGroup {
	private final HashMap<String, Boolean> lookup = new HashMap<String, Boolean>();
    private final ArrayList<String> group = new ArrayList<String>();
